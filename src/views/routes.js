...
import HightCharts from './HighCharts/Charts';
import CustomHighCharts from './HighCharts/CustomCharts';
					...
					<Row>
						...
						<Nav to="/" className="flex-sm-column" id="sidebar">
							<ListGroup className="nav nav-sidebar flex-sm-column">
								...
								<ListGroup.Item>
									<a href="#highCharts" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle"><span>HIGH CHARTS</span></a>
								</ListGroup.Item>
								<ListGroup>
									<ListGroup className="sub-menu collapse" id="highCharts">
										<ListGroup.Item> <NavLink to="/high-chart">High Chart</NavLink></ListGroup.Item>										
										<ListGroup.Item> <NavLink to="/high-chart-custome">Custome High Chart</NavLink></ListGroup.Item>
									</ListGroup>
								</ListGroup>
								<ListGroup.Item role="separator" className="divider"></ListGroup.Item>
							</ListGroup>
						...
						<Col xl={{ span: 7, offset: 3 }} lg={{ span: 8, offset: 3 }} xs={{ span: 8, offset: 2 }}>
							<Container>
								<div className="content">
									...
									<Route path="/high-chart" component={HightCharts} />
									<Route path="/high-chart-custome" component={CustomHighCharts} />
